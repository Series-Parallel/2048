package com.building2048.main2048.game;
...
import com.building2048.main2048.MainGame;
import com.building2048.main2048.gameobject.GameObject;
import com.building2048.main2048.graphics.Renderer;
import com.building2048.main2048.graphics.Sprite;
import com.building2048.main2048.input.Keyboard;
...
public class Game {
	...
	public void render() {
		...
		for(int i = 0; i < MainGame.pixels.length; i++) {
			MainGame.pixels[i] = Renderer.pixels[i];
		}
	}
	public void renderText(Graphics2D g) {
		...
		for(int i = 0; i < objects.size(); i++) {
			...
			String s = o.value + "";
			int sw = (int)(g.getFontMetrics().stringWidth(s)/ 2 / MainGame.scale);
			g.drawString(s, (int)(o.x + o.width / 2 - sw)* MainGame.scale, (int)(o.y + o.height / 2 + 18) * MainGame.scale);
		}
	}
}
